...
fabricante(){
    ...
    .then(dados => {
        ...
        <select class="select  text-center" onclick="conexao.veiculo(this.value)">
...
veiculo(marca){ 
    ...
    .then(dados => {
        ...
        <select class="select text-center" onclick="conexao.bisavo('${marca}', this.value)" >
...
bisavo(marca, veiculo){  
    ...
    `).then(dados => {
        ...
        <select class="select text-center"  onclick="conexao.avo('${marca}','${veiculo}' , this.value)">
...
avo(marca, veiculo, bisavo){  
    ...
    `).then(dados => {
        ...
        <select class="select text-center" onclick="conexao.pai('${marca}','${veiculo}', '${bisavo}' ,this.value) ">
            <option>Avo</option>
...
pai(marca, veiculo, bisavo,avo){  
    ...
    `).then(dados => {
        ...
        <select class="select text-center" onclick="conexao.enviar(this.value)">
            <option>Pai</option> 
            ${
                dados.map(item =>{
                    if(!item.Name) return
